...
module ysyx_22040000(
  ...
  // B4c: 块大小提到 32 B (8 个 word/块), 总块数提到 32, 仍 2-way. icache
  //   容量 = 32 块 * 32 B = 1 KB. multi-beat fill: miss 时连续从 bus 拉 8
  //   次 word, 每次 SimpleBus 单 word 协议, 不需要改 MemBridge.
  //   BLOCKS_LOG=5 (32 总块), WAYS_LOG=1 (2-way), OFFSET_LOG=5 (32 B/块)
  //   -> SETS = 2^(5-1) = 16, 容量 = 1024 B, BLOCK_WORDS = 8.
